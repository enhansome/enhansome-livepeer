...
* [`go-livepeer`](https://github.com/livepeer/go-livepeer) ⭐ 586 | 🐛 385 | 🌐 Go | 📅 2026-08-21 - Client software running Livepeer Public Transcoding Network.
...
* [Using `go-livepeer` to create your own platform for livestreaming](https://github.com/videodac/livepeer-broadcaster) ⭐ 25 | 🐛 4 | 🌐 Solidity | 📅 2025-11-06
* [Streaming into Decentraland with Livepeer Studio](https://github.com/decentraland-scenes/video-streaming/blob/main/README.md) ⭐ 10 | 🐛 3 | 🌐 TypeScript | 📅 2023-01-05
...
* [OurTube - decentralized YouTube sample app](https://github.com/suhailkakar/Decentralized-YouTube) ⭐ 429 | 🐛 6 | 🌐 TypeScript | 📅 2024-01-10
* [Justcast.it: 1 click "start livestream" from the browser](https://github.com/victorges/justcast.it) ⭐ 40 | 🐛 13 | 🌐 TypeScript | 📅 2023-04-30
* [Demo TikTok clone built on Livepeer + Lens Protocol](https://github.com/livepeer/livepeer-lens-shortvideos) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2023-01-25
* [WebRTMP sample app](https://github.com/livepeer/webrtmp-sdk) ⭐ 14 | 🐛 0 | 🌐 TypeScript | 📅 2023-08-07
* [Token gating a video on an EVM chain](https://github.com/suhailkakar/Livepeer-EVM-Tokengating) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2024-03-02
* [Sample app combining Filecoin's FVM and Livepeer](https://github.com/suhailkakar/FVM-x-Livepeer-Example-App) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2023-04-04
* [Mint Video NFTs on Solana](https://github.com/suhailkakar/livepeer-solana-nft) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2023-01-27
* [Sample app for video playback off of dStorage like IPFS and Arweave](https://github.com/suhailkakar/livepeer-dStorage-playback) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2022-12-12
* [Unity Livepeer Client](https://github.com/alextitonis/Unity-Livepeer-Client) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2023-04-19
* [Token gating a video on Aptos](https://github.com/suhailkakar/Livepeer-Aptos) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-28
* [Use Guild.xyz to token gate video content](https://github.com/suhailkakar/livepeer-guild-token-gated-vod) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2023-04-19
...
* [Livepeer Income Reports](https://github.com/rickstaa/livepeer-income-reports) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-01-03 - A collection of Python scripts for Livepeer delegators and orchestrators to calculate earnings and rewards and generate tax reports.
...
* [Docker Portainer](https://github.com/AuthorityNull/Livepeer-Docker-Portainer) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2022-08-12 - Guide for node operator efficiency.
* [Livepeer Reward Watcher](https://github.com/rickstaa/livepeer-reward-watcher) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2025-12-23 - Monitors your Livepeer orchestrator and alerts you when it's at risk of missing a reward call.
* [Livepeer Exporter](https://github.com/transcodeninja/livepeer-exporter) ⭐ 0 | 🐛 12 | 🌐 Go | 📅 2024-08-20 - Enhanced monitoring tool for the Livepeer network and Livepeer orchestrators.
